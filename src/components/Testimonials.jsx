import { Star, CheckCircle, Quote, ChevronRight } from 'lucide-react'
      ...
      <div className="testimonials-inner" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div className="testimonials-header reveal">
          ...
          <div className="testimonials-rating-strip">
            <div className="testimonials-rating-stars">
              {Array.from({ length: 5 }).map((_, i) => (
                <Star key={i} size={16} fill="#C81C2E" stroke="#C81C2E" />
              ))}
            </div>
        ...
        <div className="testimonials-cta" style={{ position: 'relative', zIndex: 1 }}>
          <button
            ...
            onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 8px 28px rgba(200,28,46,0.4)' }}
            onMouseLeave={(e) => { e.currentTarget.style.transform = 'none'; e.currentTarget.style.boxShadow = '0 4px 18px rgba(200,28,46,0.32)' }}
          >
            Join Our Happy Patients
            <ChevronRight size={16} />
          </button>
          <p className="testimonials-cta-note">Free consultation · No commitment</p>
        </div>
